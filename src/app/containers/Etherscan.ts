...
export const networkOptions = [
  { value: Network.DLTestNet, label: Network.DLTestNet },
...
function getSourceCodeEnpoint(network: Network, address: string): string {
  ...
  // DL Testnet explorer don't support get source code method for contract code sol version >=5.
...
export function useEtherscanABI() {
  const [network, setNetwork] = useState<Network>(Network.DLTestNet);
